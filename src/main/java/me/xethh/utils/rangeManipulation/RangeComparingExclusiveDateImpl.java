 ...
 * @date 5/25/2018
 */
public class RangeComparingExclusiveDateImpl extends RangeComparing{
    private DateRange range;
    private RangeComparingExclusiveDateImpl(DateRange range1){
        this.range = range1;
    }

    public static RangeComparing of(DateRange range){
        return new RangeComparingExclusiveDateImpl(range);
    }
