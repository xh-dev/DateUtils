...
public class FormatBuilderWrapperTest
{
    ...
    public void simpleFormatBuilderTest(){
        FormatBuilderWrapper f = DatetimeFactory.now().ymd(1988, Month.JAN, 01).hmsms(0, 0, 0, 0)
    ...
    public void testDateFormat(){
        SimpleDateFormat format = DatetimeFactory.now().format().v1().v2().v3().v4().v5().v6().v7().v8().v9().v10().v("XXX").v("yyyy")
                .v1("V1").v2("V2").v3("V3").v4("V4").v5("V5")
                .v6("V6").v7("V7").v8("V8").v9("V9").v10("V10").v("yyyy","4Y").build();
        Date date = DatetimeFactory.raw().year(2088).month(Month.NOV).day(10).hour(21).minute(56).second(58).ms(888).asDate();
        assertEquals("V1V2V3V4V5V6V7V8V9V104Y",format.format(date));
    }
    @Test
    public void testCustFormat(){
        SimpleDateFormat format = DatetimeFactory.now().format().custFormat("yyyyMMdd").build();
        Date date = DatetimeFactory.raw().year(2088).month(Month.NOV).day(10).hour(21).minute(56).second(58).ms(888).asDate();
        assertEquals("20881110",format.format(date));
    }
    @Test
    public void test(){
        SimpleDateFormat format = DatetimeFactory.now().format()
    ...
    @Test
    public void test02(){
        SimpleDateFormat format = DatetimeFactory.now().format().year4Digit().v1().month2Digit().v1().day2Digit().v2().hourInDay24().v3().minute().v3().second()
                .v1("-").v2("T").v3(":").build();
        Date date = DatetimeFactory.raw().year(2088).month(Month.NOV).day(10).hour(21).minute(56).second(58).ms(888).asDate();
    ...
    public void testTimeZone(){
        FormatBuilderWrapper format = DatetimeFactory.now().format()
        ...
        DatetimeBuilder date = DatetimeFactory.raw().year(2088).month(Month.JAN).day(10).hour(1).minute(23).second(34).timeZone(BaseTimeZone.Hongkong);
    ...
    @Test
    public void testAPM(){
        SimpleDateFormat format = DatetimeFactory.now().format().apm().v1("||").build();
        DatetimeBuilder date = DatetimeFactory.raw().year(2088).month(Month.JAN).day(10).hour(0);
    ...
    public void testHour(){
        SimpleDateFormat format = DatetimeFactory.now().format().hourInDay12().v1().hourInDay24().v1("||").build();
        DatetimeBuilder date = DatetimeFactory.raw().year(2088).month(Month.JAN).day(10).hour(0);
    ...
    public void testYear(){
        SimpleDateFormat format = DatetimeFactory.now().format().year2Digit().v1().year4Digit().v1("||").build();
        DatetimeBuilder date = DatetimeFactory.raw().year(2088).month(Month.JAN).day(10);
    ...
    public void testMonth(){
        SimpleDateFormat format = DatetimeFactory.now().format().month2Digit().v1().month3Letters().v1().monthFullName().v1("||").build();
        DatetimeBuilder date = DatetimeFactory.raw().year(2088).month(Month.JAN).day(10);
    ...
    @Test
    public void testDay(){
        SimpleDateFormat format = DatetimeFactory.now().format().day1Digit().v1().day2Digit().v1().dayWithDigit(5).v1().day2Digit().dayWithDigit(4).v1("||").build();
        DatetimeBuilder date = DatetimeFactory.raw().year(2088).month(Month.JAN).day(7);
    ...
    public void testTimeDiff(){
        SimpleDateFormat format = DatetimeFactory.now().format().hourInDay24().v1().minute().v1().second().v2().ms().v1(":").v2(".").build();
        DatetimeBuilder builder = DatetimeFactory.raw().year(2088).month(Month.JAN).day(7).minDayTime();
