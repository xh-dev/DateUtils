...
public class TestTimeZone {
    ...
    public void testTimezone() {
        DateFormatBuilder dfBuilder = DateFormatBuilder.get().custFormat(DateFormatBuilderInterface.Format.ISO8601.format());
        ...
        assertEquals("2018-01-01 21:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Hongkong.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 21:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Asia_Hong_Kong.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 21:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Asia_Shanghai.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 21:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Asia_Taipei.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 21:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Singapore.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 21:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Asia_Singapore.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 22:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Asia_Seoul.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 22:21:33.789", t2.timeZone(BaseTimeZone.UTC).format(BaseTimeZone.Japan.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        ...
        assertEquals("2018-01-01 13:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Hongkong.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 13:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Asia_Hong_Kong.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 13:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Asia_Shanghai.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 13:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Asia_Taipei.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 13:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Singapore.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 13:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Asia_Singapore.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 14:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Asia_Seoul.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
        assertEquals("2018-01-01 14:21:33.789", t2.timeZone(BaseTimeZone.Hongkong).format(BaseTimeZone.Japan.timeZone(), DateFormatBuilderInterface.Format.FULL_DATETIME));
    ...
    public void testTimeZone() {
        ...
        DatetimeBuilderInterface nowTime = DatetimeFactory.instance().now().ymd(2019, Month.FEB, 27).hmsms(13, 34, 44, 888).timeZone(BaseTimeZone.Hongkong);
