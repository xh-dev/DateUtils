...
public class DateFormatTest
{
    ...
    public void testCustFormat(){
        SimpleDateFormat format = DatetimeFactory.instance().format().custFormat("yyyyMMdd").build();
        Date date = DatetimeFactory.instance().raw().year(2088).month(Month.NOV).day(10).hour(21).minute(56).second(58).ms(888).asDate();
    ...
    public void testYear(){
        ...
        DatetimeBuilder date = DatetimeFactory.instance().raw().year(2088).month(Month.JAN).day(10);
    ...
    public void testDay(){
        ...
        DatetimeBuilder date = DatetimeFactory.instance().raw().year(2088).month(Month.JAN).day(7);
