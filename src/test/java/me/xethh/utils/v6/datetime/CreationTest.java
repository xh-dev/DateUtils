...
public class CreationTest {
    ...
    public void createDatetimeBuilder(){
        ...
        DatetimeBuilder db2 = DatetimeFactory.instance().from(-1000L * 60 * 60 * 8);
        assertEquals(db1,db2);
        DatetimeBuilder db3 = DatetimeFactory.instance().from(d);
        ...
        DatetimeBuilder db4 = DatetimeFactory.instance().from(cal);
        ...
        cal.set(Calendar.SECOND,0);
        cal.set(Calendar.MILLISECOND, 0);
        DatetimeBuilder db5 = DatetimeFactory.instance().from(cal);
        assertEquals(db1,db5);

        DatetimeBuilder db6 = DatetimeFactory.instance().from(db1);
        assertEquals(db1,db6);

        DatetimeBuilder db7 = db1.minDayTime();
        DateBuilder db8 = DateFactory.instance().raw();
