...
public class DateFormatTest
{
    ...
    public void testDateFormat(){
        SimpleDateFormat format = DatetimeFactory.format().v1().v2().v3().v4().v5().v6().v7().v8().v9().v10().v("XXX").v("yyyy")
    ...
    public void testCustFormat(){
        SimpleDateFormat format = DatetimeFactory.format().custFormat("yyyyMMdd").build();
        Date date = DatetimeFactory.raw().year(2088).month(Month.NOV).day(10).hour(21).minute(56).second(58).ms(888).asDate();
